        ...
        if i % 10 == 0:
            ...
            for i in range(nums[0]):
                ...
                if int(classes[0][i] == 67):
                    msg = str(macid) + ', ' + str(datetime.now())[:-7] + ', Object Detection, Mobile Phone detected, ' + str(
                        cpu_usage) + ', ' + str(vram) + '\n'
                    print(msg)
                    file.write(msg)
            ...
            if count == 0:
                ...
                msg = str(macid) + ', ' + str(datetime.now())[:-7] + ', Object Detection, No person detected, ' + str(
                    cpu_usage) + ', ' + str(vram) + '\n'
                print(msg)
                file.write(msg)
            elif count > 1:
                msg = str(macid) + ', ' + str(datetime.now())[:-7] + ', Object Detection, More than one person detected, ' + str(
                    cpu_usage) + ', ' + str(vram) + '\n'
                print(msg)
                file.write(msg)
            ...
            if len(faces) > 1:
                msg = str(macid) + ', ' + str(datetime.now())[:-7] + ', Face Detection, ' + str(len(faces)) + ' faces detected, ' + str(
                    cpu_usage) + ', ' + str(vram) + '\n'
                print(msg)
                file.write(msg)
            ...
            for face in faces:
                ...
                if cnt_outer > 3 and cnt_inner > 2:
                    msg = str(macid) + ', ' + str(datetime.now())[:-7] + ', Mouth Opening Detection, Mouth Opened, ' + str(
                        cpu_usage) + ', ' + str(vram) + '\n'
                    print(msg)
                    file.write(msg)
                ...
                if eye_activity:
                    msg = str(macid) + ', ' + str(datetime.now())[:-7] + ', Eye Tracking, ' + eye_activity + ", " + str(
                        cpu_usage) + ', ' + str(vram) + '\n'
                    print(msg)
                    file.write(msg)
                # Eye Tracking -------------End-----------------
                ...
                if ang1 >= 48:
                    msg = str(macid) + ', ' + str(datetime.now())[:-7] + ', Head Pose, Head Turned Down, ' + str(cpu_usage) + ', ' + str(
                        vram) + '\n'
                    print(msg)
                    file.write(msg)
                    cv2.putText(img, 'Head down', (30, 30), font, 2, (255, 255, 128), 3)
                elif ang1 <= -48:
                    msg = str(macid) + ', ' + str(datetime.now())[:-7] + ', Head Pose, Head Turned up, ' + str(cpu_usage) + ', ' + str(
                        vram) + '\n'
                    print(msg)
                    file.write(msg)
                ...
                if ang2 >= 48:
                    msg = str(macid) + ', ' + str(datetime.now())[:-7] + ', Head Pose, Head Turned Right, ' + str(cpu_usage) + ', ' + str(
                        vram) + '\n'
                    print(msg)
                    file.write(msg)
                    cv2.putText(img, 'Head right', (90, 30), font, 2, (255, 255, 128), 3)
                elif ang2 <= -48:
                    msg = str(macid) + ', ' + str(datetime.now())[:-7] + ', Head Pose, Head Turned left, ' + str(cpu_usage) + ', ' + str(
                        vram) + '\n'
                    print(msg)
                    file.write(msg)
